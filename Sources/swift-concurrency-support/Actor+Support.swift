...
extension Actor {
  public func verifier() -> (@Sendable () -> Void) {
    #if swift(>=5.9)
  ...
  public nonisolated func invoke(_ fn: @escaping () -> Void) {
  ...
  public func invoke<T: Sendable>(_ fn: @Sendable (isolated Self) async throws -> T) async rethrows
    -> T
  {
    try await fn(self)
  }
...
extension MainActor {
  ...
  public nonisolated static func `async`(fn: @escaping () -> Void) {
